...
void run_context_tests(AFGTestFramework &framework)
{
    ...
    // Test 1: Context-Sensitive vs Context-Insensitive Correctness Validation
    {
        ...
        //           << (basic_result.function_instance_counts.find("callee") != basic_result.function_instance_counts.end() ? basic_result.function_instance_counts.at("callee") : 0) << std::endl;
    ...
    // Test 6: Context String Format Validation
    {
        ...
        //     {
        //         if (context.find("@g1") != std::string::npos)
        //             found_g1_context = true;
        //         if (context.find("@g2") != std::string::npos)
        //             found_g2_context = true;
        //     }
        // }
